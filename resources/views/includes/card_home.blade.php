    ...
    <div class="card-footer bg-white">
        ...
        <div class="d-flex mb-2">
            ...
            <div class="comment ml-3 ">
                <a class="text-muted icons" href="{{ route('image.detail', ['id' => $image->id ]) }}" title="">
                    <i class="far fa-comment text-dark"></i>
                </a>
            </div>
        </div>
        @if (count($image->likes) >= 1)
            <strong style="margin-top: -8px;" class="mb-3 d-block">Le gusta a <span class="text-primary">{{ count($image->likes) }}</span> personas</strong>
        @endif
